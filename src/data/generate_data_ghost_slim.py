...
def main():
    ...
    cmd = 'sbatch -o {4} --mem=8g -t 2-00:00:00 --wrap "python3 src/data/runAndParseSlim.py src/data/introg_ghost_2pop_archieDemog_clArgs.slim {0} 50000 {1} {2} 1> {3} {5} {6} {7} {8}"'
