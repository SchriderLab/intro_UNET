...
scriptName, numReps, physLen, donorPop, introgLogFileName, nPop1, nPop2 = sys.argv[1:]
numReps = int(numReps)
physLen = int(physLen)
...
for repIndex in range(numReps):
    ...
    slimCmd = "slim -seed {} -d physLen={} -d sampleSizeSubpop1={} -d sampleSizeSubpop2={} -d donorPop={} {}".format(seed, physLen, nPop1, nPop2, donorPop, scriptName)
    ...
    mutations, genomes, introgressedAlleles = readSampleOutFromSlimRun(output, 1, int(nPop1))
    newMutLocs = []
