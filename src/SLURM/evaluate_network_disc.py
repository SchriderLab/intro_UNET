...
def main():
    ...
    if platform.platform() == 'Linux-3.10.0-1062.el7.x86_64-x86_64-with-redhat-7.7-Maipo':
        cmd = 'sbatch --partition=volta-gpu  --gres=gpu:{7} --time=2-00:00:00 --qos=gpu_access src/SLURM/run_training_disc.sh {0} {1} {2} {3} {4} {5} {6} {7}'
    elif platform.platform() == 'Linux-3.10.0-957.27.2.el7.x86_64-x86_64-with-centos-7.6.1810-Core':
        cmd = 'sbatch --partition=GPU --gres=gpu:p100:2 --time=2-00:00:00 src/SLURM/run_training_disc.sh {0} {1} {2} {3} {4} {5} {6} {7}'
